...
def main_menu_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="📝 Заполнить декларацию", callback_data="menu_upload")],
        [InlineKeyboardButton(text="📊 Статус", callback_data="menu_status")],
        [InlineKeyboardButton(text="👤 Мои профили", callback_data="menu_profiles")],
        [InlineKeyboardButton(text="📋 История деклараций", callback_data="menu_history")],
        [InlineKeyboardButton(text="❓ Помощь", callback_data="menu_help")],
        [InlineKeyboardButton(text="📩 Написать админу", url="https://t.me/silverzen")],
        [InlineKeyboardButton(text="🤖 Ещё боты", url="https://t.me/botofabrik")],
    ])
